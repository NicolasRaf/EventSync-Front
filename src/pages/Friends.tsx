...
import { ArrowLeft, UserPlus, Users, MessageCircle, Check, X, Loader2 } from 'lucide-react';
import { getFriends, getFriendRequests, respondToFriendRequest } from '../services/socialService';
...
export function Friends() {
  ...
  const handleMessage = (friendName: string) => {
      alert(`Abrindo chat com ${friendName}... (Em breve)`);
  }
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col pb-24">
      ...
      <div className="bg-white shadow-sm sticky top-0 z-10 p-4">
        <div className="gap-3 max-w-md mx-auto flex items-center">
          ...
          <h1 className="text-lg font-bold text-gray-900 truncate flex-1">Amigos</h1>
        </div>
      </div>
      ...
      <main className="flex-1 max-w-md mx-auto w-full p-4 space-y-6">
        ...
        <div className="flex p-1 bg-gray-200 rounded-xl">
            ...
            <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-bold rounded-lg transition-colors relative ${
                    activeTab === 'requests' 
                    ? 'bg-white text-gray-900 shadow-sm' 
                    : 'text-gray-500 hover:text-gray-700'
                }`}
